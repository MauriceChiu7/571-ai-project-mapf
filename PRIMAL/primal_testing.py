...
import json
import os
import PRIMAL.mapf_gym_cap as mapf_gym
import time
from od_mstar3.col_set_addition import OutOfTimeError

curr_dir = os.path.dirname(__file__)
results_path = os.path.join(curr_dir, "primal_results")
environment_path = os.path.join(curr_dir, "saved_environments")
...
class PRIMAL(object):
    ...
    def find_path(self, max_step=256):
        ...
        # while ((not self.env.finished) and step < max_step):
            timestep = []
...
if __name__ == "__main__":
    ...
    model_path = os.path.join(curr_dir, "model_primal")
